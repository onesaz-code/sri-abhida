                ...
                <div key={index} className="border border-border rounded-xl overflow-hidden">
                  <button
                    className={`w-full flex items-center justify-between p-5 text-left font-semibold font-heading transition-colors ${
                      openIndex === index ? 'bg-primary text-white' : 'bg-light text-dark hover:bg-light/80'
                    }`}
                  ...
                  {openIndex === index && (
                    <div className="p-5 bg-light/80">
                      <p className="text-dark/70 leading-relaxed">{item.content}</p>
                    </div>
                  )}
                </div>
              ))}
